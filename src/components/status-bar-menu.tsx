...
export default function StatusBarMenu({
  ...
  return (
    <div className="relative min-w-[320px] -pb-6 pt-6 px-5 shadow-[0_4px_16px_rgba(0,0,0,0.07)] bg-gradient-to-b from-[#454545] to-[#888888] font-inter text-white">
      {/* Only Search Bar */}
      <div className="relative left-0 right-0 bg-white rounded-2xl shadow-[0_4px_16px_rgba(0,0,0,0.10)] flex items-center px-4 py-4 h-14 font-inter mt-10 mb-4">
        {/* Search Icon (SVG) */}
